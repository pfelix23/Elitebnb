...
`<https://dbdiagram.io/d/BnB-Diagram-67214afcb4216d5a28a5ac50>`
...
* Request
  * Method: PATCH
  * Route path: /users/:userId/spots/:spotId/addImg
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: PATCH
  * Route path: /users/review/:reviewId/addImg
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: PATCH
  * Route path: /users/:userId/reviews/:reviewId/edit
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: PATCH
  * Route path: /users/:userId/bookings/:bookingId/edit
  * Headers:
    * Content-Type: application/json
  * Body:
